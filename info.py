...
API_ID = int(environ('API_ID', '16929529') 
API_HASH = environ('API_HASH', 'd7b9e677664d2c87db4c4c0205b6e18f')
BOT_TOKEN = environ('BOT_TOKEN', '5474689804:AAFQv7-eR9mfNtsmWy_ZOpUTLImJfhbG6r0') 
...
CUSTOM_FILE_CAPTION = environ.get("CUSTOM_FILE_CAPTION", '[𝗞𝗪𝗜𝗖]{file_name} \n\n╔════ ᴊᴏɪɴ ᴡɪᴛʜ ᴜs ═════╗\n♻️ 𝙅𝙊𝙄𝙉 :- @MoviesNowV2\n♻️ 𝙅𝙊𝙄𝙉 :- @MoviesNowOTT\n╚════ ᴊᴏɪɴ ᴡɪᴛʜ ᴜs ═════╝\n\n👆<b>ഗ്രൂപ്പിൽ join ചെയ്തതിനു  ശേഷം  File download ചെയുക </b> 🚨')
